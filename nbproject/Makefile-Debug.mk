...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE} -j4 -f nbproject/Makefile-Debug.mk dist/cofirank-debug

dist/cofirank-debug: ${OBJECTFILES}
	${MKDIR} -p dist
	${LINK.cc} -o dist/cofirank-debug ${OBJECTFILES} ${LDLIBSOPTIONS} 
